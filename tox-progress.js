const ToxProgressBar = function (element) {
...
ToxProgressBar.prototype.create = function () {
	const content = this.element.querySelector('.tox-progress-content');
...
const ToxProgress = {
	toxProgressBars: [],
	init: function () {
		const toxProgressBars = this.toxProgressBars = [];
		const toxProgressElements = document.querySelectorAll('.tox-progress');
